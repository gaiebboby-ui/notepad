...
static EDITSTYLE Styles_Markdown[] = {
	...
	{ MULTI_STYLE(SCE_MARKDOWN_INDENTED_BLOCK, SCE_MARKDOWN_BACKTICK_BLOCK, SCE_MARKDOWN_TILDE_BLOCK, 0), NP2StyleX_CodeBlock, L"font:$(Code); back:#C5C5C5; eolfilled" },
	{ SCE_MARKDOWN_CODE_SPAN, NP2StyleX_InlineCode, L"font:$(Code); back:#C5C5C5" },
	{ MULTI_STYLE(SCE_MARKDOWN_DISPLAY_MATH, SCE_MARKDOWN_BACKTICK_MATH, SCE_MARKDOWN_TILDE_MATH, 0), NP2StyleX_DisplayMath, L"font:$(Code); back:#C5C5C5; eolfilled" },
	{ MULTI_STYLE(SCE_MARKDOWN_INLINE_MATH, SCE_MARKDOWN_INLINE_DISPLAY_MATH, SCE_MARKDOWN_MATH_SPAN, 0), NP2StyleX_InlineMath, L"font:$(Code); back:#C5C5C5" },
	...
	{ SCE_MARKDOWN_DELIMITER_ROW, NP2StyleX_DelimiterRow, L"font:$(Code); bold; back:#FFC040; eolfilled" },
	{ SCE_MARKDOWN_DELIMITER, NP2StyleX_Delimiter, L"font:$(Code); bold; fore:#0080C0" },
